...
// --- Constants & Types ---
const ADULT_BELTS = [
    { name: 'White', color: 'bg-white dark:bg-zinc-900 border-gray-200 dark:border-zinc-800' },
...
const KIDS_BELTS = [
    { name: 'White', color: 'bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800' },
    { name: 'Gray-White', color: 'border border-gray-300 dark:border-zinc-700', style: { background: 'linear-gradient(180deg, #9ca3af 35%, #ffffff 35%, #ffffff 65%, #9ca3af 65%)' } },
    ...
    return (
        <div className="max-w-5xl mx-auto px-4 py-8">
            <div className="flex justify-between items-center mb-8">
                <h1 className="text-2xl font-bold text-gray-900 dark:text-zinc-100">승급 기준 설정 (Playground)</h1>
