    ...
    return (
        <div className="flex flex-col md:flex-row h-screen bg-gray-100 dark:bg-black overflow-hidden">
            ...
            <div className="md:hidden flex items-center justify-between bg-white dark:bg-zinc-900 px-5 py-3 border-b border-gray-200 dark:border-zinc-800 shadow-sm shrink-0 z-40">
                <h1 className="text-xl font-extrabold text-gray-800 dark:text-zinc-100 tracking-tight">Gym Manager</h1>
                <label htmlFor="mobile-menu" className="p-2 -mr-2 text-gray-600 dark:text-zinc-400 cursor-pointer rounded-md hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors active:bg-gray-200 dark:active:bg-zinc-700">
            ...
            <div className="group fixed inset-y-0 left-0 z-50 flex h-full pointer-events-none md:static md:z-auto md:pointer-events-auto">
                ...
                <aside className="pointer-events-auto absolute left-0 top-0 h-full w-64 bg-white dark:bg-zinc-900 shadow-2xl flex flex-col transition-transform duration-300 -translate-x-full peer-checked:translate-x-0 group-hover:translate-x-0 md:static md:translate-x-0 md:shadow-md dark:border-r dark:border-zinc-800">
                    <div className="p-6 md:block flex justify-between items-center">
                        <h1 className="text-2xl font-bold text-gray-800 dark:text-zinc-100">Gym Manager</h1>
                        <label htmlFor="mobile-menu" className="md:hidden p-2 -mr-2 text-gray-400 dark:text-zinc-500 hover:text-gray-600 dark:hover:text-zinc-300 cursor-pointer">
                            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <nav className="mt-6 px-4 space-y-2 flex-1">
                        <Link
                            href="/dashboard"
                            className="flex items-center gap-3 px-4 py-2 text-gray-700 dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-zinc-800 rounded-md transition-colors"
                        >
                    ...
                    <div className="p-4 border-t border-gray-200 dark:border-zinc-800">
                        {/* Gym & Admin Info */}
                        <Link href="/dashboard/settings/gym" className="block mb-4 p-3 bg-gray-50 dark:bg-zinc-800/50 rounded-lg hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors group">
                            <div className="flex items-center gap-3 mb-1">
                                <div className="bg-white dark:bg-zinc-800 p-1.5 rounded-full border border-gray-200 dark:border-zinc-700 text-gray-500 dark:text-zinc-400 group-hover:text-blue-600 transition-colors">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-zinc-500 group-hover:text-gray-700 dark:group-hover:text-zinc-300">{profile?.full_name || '관리자'}</p>
                                </div>
                            </div>
                        </Link>
            ...
            {/* Main Content */}
            <main className="flex-1 overflow-auto p-8 bg-gray-100 dark:bg-black">
