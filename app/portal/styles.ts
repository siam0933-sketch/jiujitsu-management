export const PORTAL_STYLES = {
    ...
    // Text Styles
    HEADING_LG: "text-2xl font-bold text-gray-900 dark:text-zinc-100 mb-6",
    HEADING_MD: "text-lg font-semibold text-gray-800 dark:text-zinc-200 mb-4",
    TEXT_BODY: "text-sm text-gray-600 dark:text-zinc-400",

    // Card Styles
    CARD: "bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-gray-100 dark:border-zinc-800 overflow-hidden",
    CARD_PADDING: "p-5",
